...
https://github.com/rajeshsahoo2006/hd_oppusecase/assets/HD%20Demo.mp4

> **Demo showcases:** Extracting opportunity from meeting summary → Interactive editable card → Direct opportunity creation → Event scheduling
